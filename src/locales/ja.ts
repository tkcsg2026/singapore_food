...
const ja: Translations = {
  ...
  suppliers: {
    ...
    categories: {
      ...
      "services-maintenance": "サービス・メンテナンス",
      "consultancy-marketing": "コンサルティング・マーケティング",
    },
    categoryGroups: {
  ...
  dashboard: {
    ...
    removeFavorite: "削除",
    supplierInsightsTitle: "掲載サプライヤー — インサイト",
    supplierInsightsSubtitle: "公開ページの閲覧数とWhatsAppタップ数です（管理者がアカウントと掲載を紐づけた場合に表示されます）。",
    supplierViewsTotal: "プロフィール閲覧（累計）",
    supplierWhatsappTotal: "WhatsAppタップ（累計）",
    supplierMonthlyBreakdown: "直近{months}ヶ月",
    supplierPublicPage: "公開ページを見る",
  },
  ...
  admin: {
    ...
    analytics: {
      ...
      supplierMonthlyReportTitle: "サプライヤー月次レポート（業者別閲覧数）",
      supplierMonthlyReportNote: "契約者向けの月次レポート用です。値は指定月のみの閲覧数・WhatsAppタップ数です。",
      monthLabel: "対象月",
      supplierLabel: "サプライヤー",
      monthlyViewsLabel: "月間閲覧数",
      monthlyWhatsappLabel: "月間WhatsAppタップ数",
      exportCsv: "CSV出力",
      xAxisMonth: "月",
      yAxisCount: "件数",
      ...
      totalWhatsappTaps: "累計WhatsAppタップ数（全サプライヤー）",
      monthlyWhatsappTaps: "月別WhatsAppタップ数（サプライヤー）",
      monthlyWhatsappTapsNote:
        "ログイン済みユーザーがサプライヤーカードまたは詳細ページでWhatsAppをタップした回数です。",
      whatsappTapsLabel: "WhatsAppタップ",
      whatsappTapsShort: "WA",
      topByWhatsapp: "WhatsAppタップ数トップ（累計）",
      whatsappCumulativeNote: "各サプライヤー掲載のWhatsApp連絡ボタンの累計タップ数です。",
    },
    supplierManagement: "サプライヤー管理",
    add: "追加",
    close: "閉じる",
    save: "保存",
    linkedSupplierLabel: "紐づける掲載サプライヤー",
    linkedSupplierHint: "ユーザーを掲載と紐づけると、ダッシュボードで閲覧数・WhatsApp数を確認できます。",
    edit: "編集",
    delete: "削除",
    create: "作成",
    update: "更新",
    ...
    homeVideo: {
      title: "ホーム紹介動画",
      description: "YouTubeのURLまたは動画ファイルをアップロードして、ホームページの「Our Services」セクションに表示します。",
      youtubeLabel: "YouTube URL",
      youtubePlaceholder: "https://www.youtube.com/watch?v=...",
      uploadLabel: "または動画ファイルをアップロード",
      currentLabel: "現在の動画",
      noVideo: "動画が設定されていません。プレースホルダーが表示されます。",
      save: "保存",
      saved: "保存しました！",
      remove: "動画を削除",
    },
  ...
  contact: {
    pageTitle: "お問い合わせ",
    pageSubtitle:
      "ご掲載をご希望の企業様は、以下の情報をご記入のうえお問い合わせください。内容を確認後、担当者よりご連絡させていただきます。",
    requiredHeading: "【必須項目】",
    requiredItems: ["会社名", "ご担当者名", "メールアドレス", "電話番号"],
    optionalHeading: "【任意項目】",
    optionalItems: [
      "取扱商品 / サービス内容",
      "会社所在地",
      "ウェブサイトURL",
    ...
    footnote1: "※ご入力いただいた情報は、お問い合わせ対応以外の目的では使用いたしません。",
    footnote2: "※営業・勧誘目的のお問い合わせはご遠慮ください。",
    sidebarEmail: "メール",
    sidebarLocation: "所在地",
    companyName: "会社名",
    contactPerson: "ご担当者名",
    email: "メールアドレス",
    phone: "電話番号",
    productsServices: "取扱商品 / サービス内容",
    companyAddress: "会社所在地",
    websiteUrl: "ウェブサイトURL",
    inquiryMessage: "ご質問・ご要望",
    optionalHint: "任意",
    submit: "送信する",
    submitting: "送信中...",
    successTitle: "送信完了！",
