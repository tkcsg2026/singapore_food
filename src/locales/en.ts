const en = {
  ...
  dashboard: {
    ...
    supplierInsightsTitle: "Your supplier listing — insights",
    supplierInsightsSubtitle: "Profile views and WhatsApp taps on your public listing (admin links your account to a supplier).",
    supplierViewsTotal: "Profile views (total)",
    supplierWhatsappTotal: "WhatsApp taps (total)",
    supplierMonthlyBreakdown: "Last {months} months",
    supplierPublicPage: "View public page",
  },
  ...
  admin: {
    ...
    analytics: {
      ...
      supplierMonthlyReportTitle: "Supplier monthly report (per supplier views)",
      supplierMonthlyReportNote: "Use this table for monthly contract reports. Values are monthly counts (views + WhatsApp taps) only.",
      monthLabel: "Month",
      supplierLabel: "Supplier",
      monthlyViewsLabel: "Monthly views",
      monthlyWhatsappLabel: "Monthly WhatsApp taps",
      ...
      totalWhatsappTaps: "Total WhatsApp taps (all suppliers)",
      monthlyWhatsappTaps: "Monthly WhatsApp taps (supplier listings)",
      monthlyWhatsappTapsNote:
        "Counted when a logged-in user taps WhatsApp on a supplier card or profile (opens wa.me).",
      whatsappTapsLabel: "WhatsApp taps",
      whatsappTapsShort: "WA",
      topByWhatsapp: "Top suppliers (WhatsApp taps)",
      whatsappCumulativeNote: "All-time WhatsApp contact taps recorded for each supplier listing.",
    },
    supplierManagement: "Supplier Management",
    add: "Add",
    close: "Close",
    save: "Save",
    linkedSupplierLabel: "Linked supplier listing",
    linkedSupplierHint: "Connect this user to a supplier so they can see views and WhatsApp stats on their dashboard.",
    edit: "Edit",
    delete: "Delete",
    create: "Create",
    update: "Update",
    ...
    homeVideo: {
      ...
      description: "Set a YouTube URL or upload a video file to display in the 'Our Services' section on the home page.",
      youtubeLabel: "YouTube URL",
      youtubePlaceholder: "https://www.youtube.com/watch?v=...",
      uploadLabel: "Or upload a video file",
      currentLabel: "Current video",
      noVideo: "No video set — a placeholder frame will be displayed.",
      save: "Save",
      saved: "Saved!",
      remove: "Remove video",
    },
  ...
  contact: {
    ...
    pageSubtitle:
      "If your company is interested in being listed, please fill in the following information and contact us. Our team will review your submission and get back to you.",
    ...
    optionalHeading: "Optional Information",
    optionalItems: [
    ...
    footnote1: "The information provided will be used solely for handling your inquiry.",
    footnote2: "Please refrain from sending inquiries for sales or solicitation purposes.",
    sidebarEmail: "Email",
